# Mona [![Build Status](https://travis-ci.org/sykopomp/mona.js.png)](https://travis-ci.org/sykopomp/mona) ![Dependencies Status](https://www.david-dm.org/sykopomp/mona.png)
